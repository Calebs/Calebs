...
function RadialProgress(container, cfg) {
  ...
  nc.style.width = "13em"; nc.style.height = "13em";
  ...
  this.setLabel = cfg.setLabel == undefined ? "Score" : cfg.tcap;
  ...
  tcc.style.display = "flex"; tcc.style.width = "100%"; tcc.style.height = "100%"; tcc.style.justifyContent = "center"; tcc.style.alignItems = "center";
  var tc = document.createElement("div");
  tc.style.display = "table-cell"; tc.style.verticalAlign = "middle";
  var tcap = document.createElement("span");
  tcap.style.display = "block"; tcap.style.verticalAlign = "middle"; tcap.style.textAlign = "inherit"; tcap.className = "data_label"
